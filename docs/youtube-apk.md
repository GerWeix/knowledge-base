...
* [Revanced CLI](https://github.com/revanced/revanced-cli) herunterladen
* [Youtube apk](https://www.apkmirror.com/apk/google-inc/youtube/youtube-20-14-43-release/youtube-20-14-43-2-android-apk-download/) herunterladen
* [Revanced Patches](https://github.com/ReVanced/revanced-patches) herunterladen
* Patchen:  
...
* .png erstellen und mit [IconKitchen](https://icon.kitchen/) für die diversen Auflösungen `ic\_launcher.png` generieren lassen
...
* [GmsCore](https://rvx.to/de/gmscore/) als Alternative zu den *Goolge Play Services* herunterladen und installieren
